...
<body class="animsition site-navbar-small dashboard">
                ...
                <div class="panel" style="margin-left: 30px;">
                    <header class="panel-heading text-center">
                        ...
                        <h1 class="panel-title"
                            style="background:#0267ca; color: #fff; font-size: large; text-align: left;">Data
                            Unit</h1>
                        ...
                        <div class="panel" style="margin-left: 30px;">
                            <header class="panel-heading text-center">
                                ...
                                <div class="panel-actions">
                                    <button type="button" class="btn"
                                        style="background:#0267ca; color: #fff; width: 5rem;" data-toggle="modal"
                                        data-target="#kodeaktivitas">+</button>
                                </div>
                            </header>
                            <div class="panel-body">
                                <table class="table table-hover dataTable table-striped w-full" data-plugin="dataTable">
                        ...
                        <div class="panel" style="margin-left: 30px;">
                            <header class="panel-heading text-center">
                                ...
                                <div class="panel-actions">
                                    <button type="button" class="btn"
                                        style="background:#0267ca; color: #fff; width: 5rem;" data-toggle="modal"
                                        data-target="#kodematerial">+</button>
                                </div>
                            </header>
                            <div class="panel-body">
                                <table class="table table-hover dataTable table-striped w-full" data-plugin="dataTable">
                        ...
                        <div class="panel" style="margin-left: 30px;">
                            <header class="panel-heading text-center">
                                ...
                                <div class="panel-actions">
                                    <button type="button" class="btn"
                                        style="background:#0267ca; color: #fff; width: 5rem;" data-toggle="modal"
                                        data-target="#kodestandby">+</button>
                                </div>
                            </header>
                            <div class="panel-body">
                                <table class="table table-hover dataTable table-striped w-full" data-plugin="dataTable">
    ...
    <script src="../../assets/mmenu/assets/examples/js/uikit/icon.js"></script>
</body>
