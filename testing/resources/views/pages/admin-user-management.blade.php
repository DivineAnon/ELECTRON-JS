                ...
                <ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" role="menu">
                            ...
                            <a class="dropdown-item" href="javascript:void(0)" role="menuitem"><i
                                    class="icon md-accounts-list" aria-hidden="true"></i>Admin</a>
                            <a class="dropdown-item" href="javascript:void(0)" role="menuitem"><i
            ...
            <div class="container">
                <div class="card text-center" style="margin-left: 65px; width: 10rem; border: 1px solid black;">
                    <div class="card-body">
                        ...
                        <button type="button" class="btn" style="border: 1px solid black; width: 5rem;"
                ...
                <div class="panel" style="margin-left: 30px;">
                    <header class="panel-heading text-center">
                        ...
                        <h1 class="panel-title"
                            style="background:#0267ca; color: #fff; font-size: large; text-align: left;">CCR
                            User</h1>
                    </header>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <select name="" class="form-control">
                                        <option value="">Data Evaluator</option>
                                    </select>
                                </div>
                            </div>
                        </div>
