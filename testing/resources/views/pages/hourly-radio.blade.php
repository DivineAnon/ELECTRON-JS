...
<head>
    ...
    <link rel="stylesheet"
        href="../../assets/global/vendor/datatables.net-rowgroup-bs4/dataTables.rowgroup.bootstrap4.css">
    <link rel="stylesheet"
        href="../../assets/global/vendor/datatables.net-scroller-bs4/dataTables.scroller.bootstrap4.css">
    <link rel="stylesheet" href="../../assets/global/vendor/datatables.net-select-bs4/dataTables.select.bootstrap4.css">
    <link rel="stylesheet"
        href="../../assets/global/vendor/datatables.net-responsive-bs4/dataTables.responsive.bootstrap4.css">
    <link rel="stylesheet"
        href="../../assets/global/vendor/datatables.net-buttons-bs4/dataTables.buttons.bootstrap4.css">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" role="menu">
                            <a class="dropdown-item" href="javascript:void(0)" role="menuitem"><i
                                    class="icon md-account" aria-hidden="true"></i> User</a>
                            <a class="dropdown-item" href="javascript:void(0)" role="menuitem"><i
                                    class="icon md-accounts-list" aria-hidden="true"></i> Data Imputer</a>
                            <a class="dropdown-item" href="javascript:void(0)" role="menuitem"><i
                                    class="icon md-calendar" aria-hidden="true"></i> 15 April 2020</a>
                            ...
                            <form action="" class="form-inline">
                                <div class="col-lg-6 col-md-12 col-sm-12">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-6 col-sm-12">
                                            <input type="text" class="form-control" name="" value="801">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-12 col-sm-12">
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-6 col-sm-12">
                                            <input type="text" class="form-control" name="" value="22">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-12 col-sm-12">
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-6 col-sm-12">
                                            <input type="text" class="form-control" name="" value="Budiman">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-6 col-sm-12">
                                            <input type="time" class="form-control" name="" value="07:00">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-6 col-sm-12">
                                            <button class="btn btn-success">Add Data Radio</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                        ...
                        <div class="card-block">
                            <header class="panel-heading text-center">
                                ...
                                <h1 class="panel-title"
                                    style="background:#0267ca; color: #fff; font-size: large; text-align: left;">Last
