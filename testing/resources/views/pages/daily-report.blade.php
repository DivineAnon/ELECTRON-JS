            ...
            <div class="collapse navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
                ...
                <ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
                    <li class="nav-item dropdown">
                        <a href="{{ route('dashboard') }}" class="nav-link waves-effect waves-light waves-round">
    ...
    <div class="site-menubar">
        <ul class="site-menu">
            ...
            <li class="site-menu-item has-sub">
                <a href="{{ route('daily-report.index') }}" id="status-unit">
        ...
        <div class="page-content container-fluid">
            ...
            <div class="container">
                <form class="form-inline mb-20">
                    {{csrf_field()}}
                    <p style="color: #000000; margin-left: 50px; margin-top: 10px !important; margin-right: 5px;">nomor
                        unit :</p>
                    <input type="text" class="form-control" name="no_unit" placeholder="No Unit" value="{{ $units }}"
                        style="margin-right: 5px;">
                    <a href="{{ route('daily-activity.index') }}"
                        class="btn btn-raised btn-primary btn-block waves-effect waves-classic" style="width: 10%;">
                        Add
                    </a>
                </form>
                        ...
                        <table class="table table-hover dataTable table-striped w-full" data-plugin="dataTable"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('daily-report.destroy', $activity->no_unit) }}" method="POST">
                                            ...
                                            @method('DELETE')
                                            <button
                                                class="button" data-original-title="Delete"
                                                data-id="{{$activity->no_unit}}">
        ...
        $('.modal-footer').on('click', '.delete', function () {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $datatable.row($('.activity' + data['id'])).remove().draw();
                }
            });
        });
